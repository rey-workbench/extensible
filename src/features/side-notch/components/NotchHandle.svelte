...
<button
  type="button"
  class="group/handle relative flex h-full w-full cursor-pointer flex-col items-center justify-between overflow-hidden border-0 bg-ext-surface p-0 outline-none select-none"
  onclick={onOpen}
